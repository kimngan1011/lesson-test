...
export class BOLesson {
    ...
    switch (option) {
      case "teacher":
        if (lessonType === "oneTimeIndividual") {
          await this.page
            .getByTestId("FilterLessonList__teachers")
            .getByLabel("Teacher Name")
            .fill(LESSON_NAME.teacherOneTimeIndividual);
          await this.page.getByTestId("MTooltipBase").getByText(LESSON_NAME.teacherOneTimeIndividual).click();
        }
        if (lessonType === "oneTimeGroup") {
          await this.page
            .getByTestId("FilterLessonList__teachers")
            .getByLabel("Teacher Name")
            .fill(LESSON_NAME.teacherOneTimeGroup);
          await this.page.getByTestId("MTooltipBase").getByText(LESSON_NAME.teacherOneTimeGroup).click();
        }
        if (lessonType === "recurringIndividual") {
          await this.page
            .getByTestId("FilterLessonList__teachers")
            .getByLabel("Teacher Name")
            .fill(LESSON_NAME.teacherRecurringIndividual);
          ...
          await this.page
            .getByTestId("FilterLessonList__teachers")
            .getByLabel("Teacher Name")
            .fill(LESSON_NAME.teacherRecurringGroup);
  ...
  public async getNextLessonDateLink(format: "nextLessonDate" | "lAEndDate" | "orderStartDate") {
    ...
    if (format === "orderStartDate") {
      const orderStartDate = `${day}/${month}/${year}`;
  ...
  public async editLesson(
    ...
    await this.page
      .getByTestId("SectionLessonTime__endTime")
      .locator("#AutocompleteTimeOfDayHF__autocomplete")
      .fill("14:00");
    ...
    await this.page
      .getByTestId("SectionClassroom__autocomplete")
      .getByLabel("Classroom")
      .fill(LESSON_NAME.newClassroom);
    ...
    await this.page
      .getByTestId("SectionLiveStreamingSF__textField")
      .getByTestId("MTextFieldHF__input")
      .fill("https://us06web.zoom.us/j/83241203966");
  ...
  public async publishLessonOnBO() {
    await this.page.getByLabel("Select all items").click();
  ...
  public async collectAttendanceOnBO(attendanceType: "attend" | "absent" | "late" | "allAttend") {
    ...
    await this.page.getByTestId("MoreHorizIcon").nth(0).click();
  ...
  public async removeStudentOnBO(
    ...
    await this.page.getByTestId("ActionPanel__trigger").nth(0).click();
